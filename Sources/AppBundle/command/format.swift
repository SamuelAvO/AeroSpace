...
private func toLayoutString(tc: TilingContainer) -> String {
    switch (tc.layout, tc.orientation) {
        ...
        case (.scrolling, .h): return LayoutCmdArgs.LayoutDescription.h_scrolling.rawValue
        case (.scrolling, .v): return LayoutCmdArgs.LayoutDescription.v_scrolling.rawValue
    }
}
