...
struct LayoutCommand: Command {
    ...
    func run(_ env: CmdEnv, _ io: CmdIo) async throws -> Bool {
        ...
        switch targetDescription {
            ...
            case .v_scrolling:
                return changeTilingLayout(io, targetLayout: .scrolling, targetOrientation: .v, window: window)
            case .h_tiles:
            ...
            case .scrolling:
                return changeTilingLayout(io, targetLayout: .scrolling, targetOrientation: nil, window: window)
            case .tiles:
...
extension Window {
    fileprivate func matchesDescription(_ layout: LayoutCmdArgs.LayoutDescription) -> Bool {
        return switch layout {
            ...
            case .h_scrolling: (parent as? TilingContainer).map { $0.layout == .scrolling && $0.orientation == .h } == true
            case .v_scrolling: (parent as? TilingContainer).map { $0.layout == .scrolling && $0.orientation == .v } == true
